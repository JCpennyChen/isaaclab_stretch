...
def main():
    ...
    # Collector for phase 1 + 2 (reaching + inserting)
    ...
    collector_reach.reset()
    collector_pull.reset()
    ...
    while simulation_app.is_running():
        ...
        body_joint_names = [
            ...
            "joint_gripper_.*",
            "joint_arm_.*",
            # "joint_head_.*",          # Note: For later updates when we want to enable head tracking as well
        ]
